<?php
class SignatureToImageComponent extends Component {
...
* @return object
*/
	public function signJsonToImage ($json, $options = array()) {
 ...
 *  @return void
 */
	public function saveImage($img, $sign_image = null) {
			imagepng($img, $sign_image);
			imagedestroy($img);
	}
}